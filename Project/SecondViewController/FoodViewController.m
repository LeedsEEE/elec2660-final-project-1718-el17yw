...
//change the color of every cell to be the same
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    UIColor *testColor1= [UIColor colorWithRed:254/255.0 green:255/255.0 blue:237/255.0 alpha:1];
    cell.backgroundColor = testColor1;
}
